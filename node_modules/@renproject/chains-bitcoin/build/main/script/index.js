...
exports.calculatePubKeyScript = exports.createAddressBuffer = void 0;
...
const createAddressBuffer = (gGubKeyHash, gHash, prefix) => gatewayScript(gGubKeyHash, gHash).toAddress(prefix);
