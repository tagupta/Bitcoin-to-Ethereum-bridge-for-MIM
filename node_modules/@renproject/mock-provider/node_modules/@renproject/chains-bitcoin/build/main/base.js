...
class BitcoinBaseChain {
    constructor(network) {
        ...
        this.getGatewayAddress = (asset, publicKey, gHash) => {
            ...
            return this.utils.addressBufferToString(index_1.createAddressBuffer(utils_1.hash160(publicKey), gHash, this.utils.p2shPrefix[isTestnet ? "testnet" : "mainnet"]));
        };
        /**
        ...
        this.bytesToAddress = (address) => {
            ...
            return bech32_1.default.encode("", words);
        };
