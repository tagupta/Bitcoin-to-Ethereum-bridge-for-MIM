...
exports.BscConfigMap = {
    [interfaces_1.RenNetwork.Mainnet]: exports.renBscMainnet,
    [interfaces_1.RenNetwork.Testnet]: exports.renBscTestnet,
    [interfaces_1.RenNetwork.Devnet]: exports.renBscDevnet,
};
const resolveBSCNetwork = (renNetwork) => {
    if (!renNetwork) {
        return exports.BscConfigMap[interfaces_1.RenNetwork.Mainnet];
    }
    if (renNetwork.addresses) {
        ...
        return details.isTestnet
            ? details.name === interfaces_1.RenNetwork.Devnet
