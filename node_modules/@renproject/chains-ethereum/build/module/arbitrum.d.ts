...
export declare const renArbitrumTestnet: EthereumConfig;
export declare const renArbitrumMainnet: EthereumConfig;
export declare const ArbitrumConfigMap: {
    testnet: EthereumConfig;
    mainnet: EthereumConfig;
};
export declare class ArbitrumClass extends EthereumClass {
    static chain: string;
    chain: string;
    name: string;
...
export declare type Arbitrum = ArbitrumClass;
export declare const Arbitrum: import("@renproject/utils").CallableConstructor<typeof ArbitrumClass>;
