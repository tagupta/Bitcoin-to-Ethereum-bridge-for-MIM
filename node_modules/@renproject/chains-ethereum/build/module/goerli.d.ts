...
export declare const renGoerli: EthereumConfig;
export declare const GoerliConfigMap: {
    testnet: EthereumConfig;
};
export declare class GoerliClass extends EthereumClass {
    static chain: string;
    chain: string;
    name: string;
...
export declare type Goerli = GoerliClass;
export declare const Goerli: import("@renproject/utils").CallableConstructor<typeof GoerliClass>;
